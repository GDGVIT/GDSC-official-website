export const handleTeamScroll = () => {
  ...
  // document.querySelector('.horizontal-section2').style.height =
  //   horLength2 + 'px';
  window.onscroll = () => {
    ...
    //   document.querySelector('.element-wrapper2').style.transform =
    //     'translateX(-' + (scrollTop - distFromTop2) + 'px)';
    // }
  };
};
